...
> **Ghi chú:** Phần User Stories và Tiêu chí nghiệm thu (Acceptance Criteria) được tách riêng tại [user-stories.md](./user-stories.md).
...
**User Story liên quan:** US-001 (xem [user-stories.md](./user-stories.md))
...
**User Story liên quan:** US-002 (xem [user-stories.md](./user-stories.md))
...
**User Story liên quan:** US-003 (xem [user-stories.md](./user-stories.md))
...
**User Story liên quan:** US-004 (xem [user-stories.md](./user-stories.md))
...
**User Story liên quan:** US-005 (xem [user-stories.md](./user-stories.md))
...
**User Story liên quan:** US-006 (xem [user-stories.md](./user-stories.md))
...
- [Luồng C — Lịch bảo vệ thay đổi]: Nếu lịch bị điều chỉnh, hệ thống hiển thị thông báo "Lịch bảo vệ đã được thay đổi" kèm thông tin mới.
...
**User Story liên quan:** US-007 (xem [user-stories.md](./user-stories.md))
...
> **Xem tiếp:** [User Stories & Tiêu chí nghiệm thu](./user-stories.md)
